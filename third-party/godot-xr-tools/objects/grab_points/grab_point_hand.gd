...
const LEFT_HAND_PATH := "res://third-party/godot-xr-tools/hands/scenes/lowpoly/left_hand_low.tscn"

## Right hand scene path (for editor preview)
const RIGHT_HAND_PATH := "res://third-party/godot-xr-tools/hands/scenes/lowpoly/right_hand_low.tscn"
