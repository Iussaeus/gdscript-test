@tool
@icon("res://third-party/godot-xr-tools/editor/icons/movement_provider.svg")
...
## Player body scene
const PLAYER_BODY := preload("res://third-party/godot-xr-tools/player/player_body.tscn")
